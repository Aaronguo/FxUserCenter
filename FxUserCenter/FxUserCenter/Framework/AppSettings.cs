...
namespace FxUserCenter
{
    public class AppSettings
    {
        ...
        public static string YingTaoUserCenterUrl()
        {
            if (cacheService.Get("YingTaoUserCenterUrl") == null)
            {
                cacheService.Insert("YingTaoUserCenterUrl", GetString("YingTaoUserCenterUrl", "http://usercenter.yingtao.co.uk/"), 3600, System.Web.Caching.CacheItemPriority.Default);
            }
            object o = cacheService.Get("YingTaoUserCenterUrl");
            if (o != null)
            {
                return o.ToString();
            }
        ...
        public static string YingTaoUserCenterCssUrl(string cssname)
        {
            return string.Format("{0}/Content/css/{1}", YingTaoUserCenterUrl(), cssname);
        }


        public static string YingTaoUserCenterJsUrl(string jsname)
        {
            return string.Format("{0}/Content/js/{1}", YingTaoUserCenterUrl(), jsname);
        }

        public static string YingTaoUserCenterImageUrl(string imagename)
        {
            return string.Format("{0}/Content/image/{1}", YingTaoUserCenterUrl(), imagename);
        }
